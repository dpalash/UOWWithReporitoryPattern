namespace UOWWithReporitoryPattern.NewFolder1
{
    ...
    public partial class customer
    {
        ...
        public customer()
        {
            ...
            EncOrderHeaders = new HashSet<EncOrderHeader>();
            FrequentlyUsedEncProducts = new HashSet<FrequentlyUsedEncProduct>();
            IssuersCustomerInfoes = new HashSet<IssuersCustomerInfo>();
            OrderHeaders = new HashSet<OrderHeader>();
            PreorderedPublicationInformations = new HashSet<PreorderedPublicationInformation>();
